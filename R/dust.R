...
model <- R6::R6Class(
  ...
  private = list(
    ...
    param_ = list(N = list(has_default = TRUE, default_value = 750000L, rank = 0, min = -Inf, max = Inf, integer = FALSE),
     ...
     kappa_cases = list(has_default = TRUE, default_value = 5L, rank = 0, min = -Inf, max = Inf, integer = FALSE),
     ...
     use_nbinom = list(has_default = TRUE, default_value = 0L, rank = 0, min = 0L, max = 1L, integer = FALSE),
