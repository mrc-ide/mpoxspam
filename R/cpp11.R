...
dust_cpu_model_alloc <- function(r_pars, pars_multi, r_time, r_n_particles, n_threads, r_seed, deterministic, gpu_config, ode_control) {
  .Call(`_mpoxspam_dust_cpu_model_alloc`, r_pars, pars_multi, r_time, r_n_particles, n_threads, r_seed, deterministic, gpu_config, ode_control)
}

dust_cpu_model_capabilities <- function() {
  .Call(`_mpoxspam_dust_cpu_model_capabilities`)
}

dust_cpu_model_run <- function(ptr, r_time_end) {
  .Call(`_mpoxspam_dust_cpu_model_run`, ptr, r_time_end)
}
